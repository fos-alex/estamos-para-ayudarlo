...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Mapas.Developer.Delete');
$can_edit		= $this->auth->has_permission('Mapas.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/mapas/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->text); ?></td>
				<?php else : ?>
