...
$num_columns	= 6;
$can_delete	= $this->auth->has_permission('Mapas.Reports.Delete');
$can_edit		= $this->auth->has_permission('Mapas.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/mapas/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->text); ?></td>
				<?php else : ?>
