...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Mapas.Settings.View');
	...
	{
		$this->auth->restrict('Mapas.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_mapas())
			{
				...
				redirect(SITE_AREA .'/settings/mapas');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Mapas.Settings.Edit');
		...
		{
			$this->auth->restrict('Mapas.Settings.Delete');
