...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Mapas.Developer.View');
	...
	{
		$this->auth->restrict('Mapas.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_mapas())
			{
				...
				redirect(SITE_AREA .'/developer/mapas');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Mapas.Developer.Edit');
		...
		{
			$this->auth->restrict('Mapas.Developer.Delete');
