...
$num_columns	= 7;
$can_delete	= $this->auth->has_permission('ProductosDetalle.Developer.Delete');
$can_edit		= $this->auth->has_permission('ProductosDetalle.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/productosdetalle/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->id_producto); ?></td>
				<?php else : ?>
