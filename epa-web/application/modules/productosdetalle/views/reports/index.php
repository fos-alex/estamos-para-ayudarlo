...
$num_columns	= 7;
$can_delete	= $this->auth->has_permission('ProductosDetalle.Reports.Delete');
$can_edit		= $this->auth->has_permission('ProductosDetalle.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/productosdetalle/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->id_producto); ?></td>
				<?php else : ?>
