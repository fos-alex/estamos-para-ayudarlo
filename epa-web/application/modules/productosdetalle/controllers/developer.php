...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('ProductosDetalle.Developer.View');
	...
	{
		$this->auth->restrict('ProductosDetalle.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_productosdetalle())
			{
				...
				redirect(SITE_AREA .'/developer/productosdetalle');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('ProductosDetalle.Developer.Edit');
		...
		{
			$this->auth->restrict('ProductosDetalle.Developer.Delete');
