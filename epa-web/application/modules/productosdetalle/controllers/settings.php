...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('ProductosDetalle.Settings.View');
	...
	{
		$this->auth->restrict('ProductosDetalle.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_productosdetalle())
			{
				...
				redirect(SITE_AREA .'/settings/productosdetalle');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('ProductosDetalle.Settings.Edit');
		...
		{
			$this->auth->restrict('ProductosDetalle.Settings.Delete');
