...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('ProductosDetalle.Reports.View');
	...
	{
		$this->auth->restrict('ProductosDetalle.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_productosdetalle())
			{
				...
				redirect(SITE_AREA .'/reports/productosdetalle');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('ProductosDetalle.Reports.Edit');
		...
		{
			$this->auth->restrict('ProductosDetalle.Reports.Delete');
