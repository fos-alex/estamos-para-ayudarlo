...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Supermercados.Developer.View');
	...
	{
		$this->auth->restrict('Supermercados.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_supermercados())
			{
				...
				redirect(SITE_AREA .'/developer/supermercados');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Supermercados.Developer.Edit');
		...
		{
			$this->auth->restrict('Supermercados.Developer.Delete');
