...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Supermercados.Reports.View');
	...
	{
		$this->auth->restrict('Supermercados.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_supermercados())
			{
				...
				redirect(SITE_AREA .'/reports/supermercados');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Supermercados.Reports.Edit');
		...
		{
			$this->auth->restrict('Supermercados.Reports.Delete');
