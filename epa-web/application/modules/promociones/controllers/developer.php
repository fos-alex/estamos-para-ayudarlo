...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Promociones.Developer.View');
	...
	{
		$this->auth->restrict('Promociones.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_promociones())
			{
				...
				redirect(SITE_AREA .'/developer/promociones');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Promociones.Developer.Edit');
		...
		{
			$this->auth->restrict('Promociones.Developer.Delete');
