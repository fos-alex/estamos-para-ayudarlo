...
class content extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Promociones.Content.View');
	...
	{
		$this->auth->restrict('Promociones.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_promociones())
			{
				...
				redirect(SITE_AREA .'/content/promociones');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Promociones.Content.Edit');
		...
		{
			$this->auth->restrict('Promociones.Content.Delete');
