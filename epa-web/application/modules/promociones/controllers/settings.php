...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Promociones.Settings.View');
	...
	{
		$this->auth->restrict('Promociones.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_promociones())
			{
				...
				redirect(SITE_AREA .'/settings/promociones');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Promociones.Settings.Edit');
		...
		{
			$this->auth->restrict('Promociones.Settings.Delete');
