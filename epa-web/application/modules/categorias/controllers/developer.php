...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Categorias.Developer.View');
	...
	{
		$this->auth->restrict('Categorias.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_categorias())
			{
				...
				redirect(SITE_AREA .'/developer/categorias');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Categorias.Developer.Edit');
		...
		{
			$this->auth->restrict('Categorias.Developer.Delete');
