...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Categorias.Reports.View');
	...
	{
		$this->auth->restrict('Categorias.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_categorias())
			{
				...
				redirect(SITE_AREA .'/reports/categorias');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Categorias.Reports.Edit');
		...
		{
			$this->auth->restrict('Categorias.Reports.Delete');
