...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Sucursales.Reports.View');
	...
	{
		$this->auth->restrict('Sucursales.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_sucursales())
			{
				...
				redirect(SITE_AREA .'/reports/sucursales');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Sucursales.Reports.Edit');
		...
		{
			$this->auth->restrict('Sucursales.Reports.Delete');
