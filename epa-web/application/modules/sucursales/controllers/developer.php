...
class developer extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Sucursales.Developer.View');
	...
	{
		$this->auth->restrict('Sucursales.Developer.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_sucursales())
			{
				...
				redirect(SITE_AREA .'/developer/sucursales');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Sucursales.Developer.Edit');
		...
		{
			$this->auth->restrict('Sucursales.Developer.Delete');
