...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Sucursales.Settings.View');
	...
	{
		$this->auth->restrict('Sucursales.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_sucursales())
			{
				...
				redirect(SITE_AREA .'/settings/sucursales');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Sucursales.Settings.Edit');
		...
		{
			$this->auth->restrict('Sucursales.Settings.Delete');
