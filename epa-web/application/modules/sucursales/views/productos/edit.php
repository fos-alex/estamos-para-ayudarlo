	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="form-actions">
				...
				<?php echo lang('bf_or'); ?>
				<?php echo anchor(SITE_AREA .'/productos/sucursales', lang('sucursales_cancel'), 'class="btn btn-warning"'); ?>
				
			<?php if ($this->auth->has_permission('Sucursales.Productos.Delete')) : ?>
				or
				<button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('sucursales_delete_confirm'))); ?>'); ">
					<span class="icon-trash icon-white"></span>&nbsp;<?php echo lang('sucursales_delete_record'); ?>
				</button>
			<?php endif; ?>
			</div>
		</fieldset>
