...
class Migration_Install_precioscuidados_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'PreciosCuidados.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PreciosCuidados.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PreciosCuidados.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'PreciosCuidados.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
