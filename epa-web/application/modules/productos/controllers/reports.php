...
class reports extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Productos.Reports.View');
	...
	{
		$this->auth->restrict('Productos.Reports.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_productos())
			{
				...
				redirect(SITE_AREA .'/reports/productos');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Productos.Reports.Edit');
		...
		{
			$this->auth->restrict('Productos.Reports.Delete');
