...
class settings extends Admin_Controller
{
	...
	public function __construct()
	{
		...
		$this->auth->restrict('Productos.Settings.View');
	...
	{
		$this->auth->restrict('Productos.Settings.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_productos())
			{
				...
				redirect(SITE_AREA .'/settings/productos');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Productos.Settings.Edit');
		...
		{
			$this->auth->restrict('Productos.Settings.Delete');
