...
class content extends Admin_Controller
{
	...
	{
		$this->auth->restrict('Productos.Content.Create');
		...
		if (isset($_POST['save']))
		{
			if ($insert_id = $this->save_productos())
			{
				...
				redirect(SITE_AREA .'/content/productos');
			}
			else
			{
	...
	public function edit()
	{
		...
		if (isset($_POST['save']))
		{
			$this->auth->restrict('Productos.Content.Edit');
		...
		{
			$this->auth->restrict('Productos.Content.Delete');
