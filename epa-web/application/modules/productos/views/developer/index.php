...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Productos.Developer.Delete');
$can_edit		= $this->auth->has_permission('Productos.Developer.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/developer/productos/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->id_supermercado); ?></td>
				<?php else : ?>
