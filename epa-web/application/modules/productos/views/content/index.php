...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Productos.Content.Delete');
$can_edit		= $this->auth->has_permission('Productos.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/productos/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->id_supermercado); ?></td>
				<?php else : ?>
