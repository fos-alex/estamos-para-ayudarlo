...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Productos.Reports.Delete');
$can_edit		= $this->auth->has_permission('Productos.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/productos/edit/' . $record->id, '<span class="icon-pencil"></span>' .  $record->id_supermercado); ?></td>
				<?php else : ?>
